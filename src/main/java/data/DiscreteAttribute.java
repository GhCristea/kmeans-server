...
public class DiscreteAttribute extends Attribute implements Iterable<String>{
	...
	/**
	 * Class construcor.
	 * @param setName name of attribute
	 * @param setIndex index of attribute
	 * @param setValues value of attribute
	 */
	 ...
	 * @param idList indexes of values
	 * @param value value to calculate the frequecy
